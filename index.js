...
if (!user.username) {
    ...
    if (option.options === "Find Your Average") {
        ...
        if (findAverage.average === "Find Average Of Last Series") {
            ...
            let totalRunsScored = runsScored1.firstMatchRuns +
            ...
            console.log(`In last series you scored ${totalRunsScored} runs and got out ${totalNumberOfOuts} times so your average is ${average.toFixed(2)} `);
        }
        else if (findAverage.average === "Find Collective Average Of All Matches") {
            ...
            console.log(`You played ${totalMatches} matches and scored ${totalRuns} runs so your average is ${average.toFixed(2)}`);
        }
    }
        ...
        if (findStrikeRate.strikeRate === "Find Strike Rate Of Last Series") {
            ...
            let totalRunsScored = runsScored1.firstMatchRuns +
                runsScored2.secondMatchRuns +
                runsScored3.thirdMatchRuns;
            let totalBallsFaced = ballsFaced1.firstMatchBalls +
        ...
        if (findStrikeRateAndAverage.strikeRateAndAverage ===
            "Find Complete Stats Of Your Last Series") {
            let ballsFaced1 = await inquirer.prompt({
                message: "How many balls you faced in 1st match of the series?",
                type: "number",
